...
Pensez-y très concrètement comme à un agent de sécurité intelligent (un portier) posté au point d'entrée principal de votre réseau. Il se tient sur le "pont-levis" numérique qui sépare votre réseau interne privé (votre "château" où se trouvent vos données précieuses) de l'Internet public (le "monde extérieur", vaste et imprévisible).
